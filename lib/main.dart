  ...
  Widget build(BuildContext context) {
    ...
    Widget networkSvg = SvgPicture.network(
      ...
      placeholderBuilder: (BuildContext context) => Container(
          padding:
              EdgeInsets.only(left: AppSize.getWidth(context, 16), bottom: 0),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          padding: EdgeInsets.only(top: AppSize.getHeight(context, 400)),
          child: Flex(
            ...
            children: <Widget>[
              ...
              SizedBox(
                width: isScreenWide?AppSize.getWidth(context, 100):0,
                height: isScreenWide?0:AppSize.getHeight(context, 40),
              ),
              Container(
